<template>
	<view v-if="show" class="uni-noticebar" :style="{ backgroundColor }" @click="onClick">
		<uniIcons v-if="showIcon === true || showIcon === 'true'" class="uni-noticebar-icon" type="sound"
		...
		<view v-if="isShowGetMore" class="uni-noticebar__more uni-cursor-point"
			...
			<uniIcons v-else type="right" :color="moreColor" :size="fontSize * 1.1" />
		</view>
		<view class="uni-noticebar-close uni-cursor-point" v-if="isShowClose">
			<uniIcons type="closeempty" :color="color" :size="fontSize * 1.1" @click="close" />
		</view>
	</view>
</template>
